...
from eeggan.model.progressive.handler import ProgressionHandler
from eeggan.training.trainer.utils import detach_all


class wgangp(LightningModule):

    def __init__(self, i_logging: int,
        ...
        self.progress = progression_handler
    ...
    def train_discriminator(self, batch_real: WindowsDataset, batch_fake: WindowsDataset, latent: torch.Tensor):
    ...
    def train_generator(self, batch_real: WindowsDataset):
