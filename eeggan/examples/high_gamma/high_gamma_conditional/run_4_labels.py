...
from eeggan.examples.high_gamma.high_gamma_softplus.make_data_all_labels import (FS, N_PROGRESSIVE_STAGES,
 INPUT_LENGTH)
...
n_epochs_per_stage = 3000
EXPERIMENT = 'all_labels'
VERSION = 'all_labels_2'
...
DEFAULT_CONFIG = dict(
    ...
    n_classes=4,  # number of classes in data
