...
from legacy_code.paths import results_path
...
def generate_data(model_token, stage, n_samples):
    ...
    ----------
        ds: EEGGAN_Dataset
            The generated data.
    """
    model_token = os.path.join(
        results_path, "EEGGAN", model_token, "checkpoints/last.ckpt"
    )
    print(model_token)
    ...
    for batch in range(n_samples // batch_size):
        ...
        y_fake_batch = torch.randint(
            low=0, high=model.hparams.n_classes, size=(batch_size,), dtype=torch.int32
        )
