...
class LoggingHandler(Callback):
    ...
    def on_train_epoch_end(self, trainer:Trainer, module:LightningModule):
        ...
        if trainer.current_epoch == trainer.max_epochs - 1:
            ...
            filter_block2 = module.generator.blocks[1].intermediate_sequence[1].conv2.weight.data.clone().flatten()
            filter_block3 = module.generator.blocks[2].intermediate_sequence[1].conv2.weight.data.clone().flatten()
